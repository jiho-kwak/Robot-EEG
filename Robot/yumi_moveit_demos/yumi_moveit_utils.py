...
table_height = 0.07 #0.045#:The height of the upper surface of the table
...
def init_Moveit():
    ...
    scene.remove_world_object("height_restraint")
    scene.remove_world_object("width_restraint")
    scene.remove_world_object("restraint_1")
    scene.remove_world_object("restraint_2")
    scene.remove_world_object("restraint_3")
    ...
    # scene.add_box("table", p, (1, 2, 0.005))

    # add an object to be grasped
    # p.pose.position.x = 0.25
    # p.pose.position.y = 0.20
    # p.pose.position.z = 0.005
    # scene.add_box("part", p, (0.03, 0.03, 0.01))

    # p.pose.position.x = 0.25
    # p.pose.position.y = 0.0
    # p.pose.position.z = 0.7
    # scene.add_box("height_restraint", p, (1, 1, 0.005))
    ...
    # scene.add_box("restraint_1", p, (0.1, 0.001, 0.2))

    # p.pose.position.x = 0.75
    # p.pose.position.y = 0.2
    # p.pose.position.z = 0.1
    # scene.add_box("restraint_2", p, (0.1, 0.001, 0.2))

    # p.pose.position.x = 0.0
    # p.pose.position.y = 0.55
    # p.pose.position.z = 0.3
    # scene.add_box("restraint_3", p, (1, 0.005, 1))
